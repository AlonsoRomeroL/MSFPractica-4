...
def controlador(kP, kI, kD, sys):
    ...
    print(f" el valor de capacitancia Cr es: {Cr} Faradios.\n")
    print(f" el valor de resistencia Re es: {Re} Ohms.\n")
    print(f" el valor de resistencia Rr es: {Rr} Ohms.\n")
    print(f" el valor de capacitancia Ce es: {Ce} Faradios.\n")
